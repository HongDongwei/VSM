...
public class UserInsert {
    ...
    public UserInsert(String time, String place, String thing, String cycle, int degree, String label, int isremind, String type, int state, String startdate, String enddate, int s_userid, int status) {
        this.status = status;
        this.time = time;
        this.place = place;
        this.thing = thing;
    ...
    public UserInsert(Schedule schedule) {
